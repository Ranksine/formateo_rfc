function formatear(date){
    ...
    console.log(array[0]);
    cadena=array[0];
    cadenarecortada=cadena.slice(2, 4)
    //from array concatenate into new date string format: "DD.MM.YYYY"
    var newDate = (cadenarecortada + "" + array[1] + "" + array[2]);
    return newDate;
}
...
function calcula() {
    var ap_paterno = "paterno";
    var ap_materno = "materno";
    var nombre = "nombre";
    var rfc = "00000";
    var fnac = "";
    var sexo = "x";  //h =  hombre  m= mujer
    var estado = "JAL";  //falta validacion de estados

    var ap_paterno = document.getElementById("paterno").value;
    var ap_materno = document.getElementById("materno").value;
    var nombre = document.getElementById("nombre").value;
    var rfc = document.getElementById("fecha_nac").value;
    // var sexo = document.getElementById("sexo").value;

    // var estado = document.getElementById("estado").value;
    fnac=formatear(rfc);
    var dteNacimiento = fnac;
    //FILTRA ACENTOS
...
function RFCQuitaProhibidas(rfc) {
    var res;
    rfc = rfc.toUpperCase();
    var strPalabras = "BACA*BAKA*BUEI*BUEY*CACA*CACO*CAGA*CAGO*CAKA*";
            strPalabras = strPalabras + "CAKO*COGE*COGI*COJA*COJE*COJI*COJO*COLA*CULO*";
    strPalabras = strPalabras + "FALO*FETO*GETA*GUEI*GUEY*JETA*JOTO*KACA*KACO*";
    strPalabras = strPalabras + "KAGA*KAGO*KAKA*KAKO*KOGE*KOGI*KOJA*KOJE*KOJI*";
    strPalabras = strPalabras + "KOJO*KOLA*KULO*LILO*LOCA*LOCO*LOKA*LOKO*MAME*";
    strPalabras = strPalabras + "MAMO*MEAR*MEAS*MEON*MIAR*MION*MOCO*MOKO*MULA*";
    strPalabras = strPalabras + "MULO*NACA*NACO*PEDA*PEDO*PENE*PIPI*PITO*POPO*";
    strPalabras = strPalabras + "PUTA*PUTO*QULO*RATA*ROBA*ROBE*ROBO*RUIN*SENO*";
    strPalabras = strPalabras + "TETA*VACA*VAGA*VAGO*VAKA*VUEI*VUEY*WUEI*WUEY*";
